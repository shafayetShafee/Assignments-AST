...
\usepackage[top=1in,bottom=1in,right=1.1in,left=1.1in]{geometry}
\usepackage{color}
\usepackage{fancyvrb}
\newcommand{\VerbBar}{|}
...
\NormalTok{reg\_eq }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, ref, ...) \{}
  \FunctionTok{extract\_eq}\NormalTok{(mod,}
             ...
             \AttributeTok{label =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"eq"}\NormalTok{,ref),}
\NormalTok{             ...)}
\NormalTok{\}}

\NormalTok{params }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mod, param, }\AttributeTok{dec =} \DecValTok{2}\NormalTok{) \{}
...
\FunctionTok{kab\_tab}\NormalTok{(tab\_p,}
        \AttributeTok{caption =} \StringTok{"Descriptive Statistics"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \StringTok{"hold\_position"}\NormalTok{)}
